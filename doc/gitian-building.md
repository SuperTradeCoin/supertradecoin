...
*Setup instructions for a gitian build of SuperTradeCoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the SuperTradeCoin
...
- [Building SuperTradeCoin](#building-supertradecoin)
...
Clone the git repositories for supertradecoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/supertradecoin/supertradecoin
```
...
In [doc/release-process.md](release-process.md) in the supertradecoin repository under 'Fetch and build inputs'.
...
Building SuperTradeCoin
----------------

To build SuperTradeCoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the supertradecoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/supertradecoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/supertradecoin/supertradecoin
...
For example:
```bash
URL=https://github.com/langerhans/supertradecoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit supertradecoin=${COMMIT} --url supertradecoin=${URL} ../supertradecoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit supertradecoin=${COMMIT} --url supertradecoin=${URL} ../supertradecoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/supertradecoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/supertradecoin-build.assert
```
...
[supertradecoin/gitian.sigs](https://github.com/supertradecoin/gitian.sigs/) repository, or
