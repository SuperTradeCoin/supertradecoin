...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SuperTradeCoin"),
     ...
     * override -datadir in the supertradecoin.conf file in the default data directory
     * (to be consistent with supertradecoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
