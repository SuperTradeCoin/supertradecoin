...
In order to support loading of multiple wallets in minegoldcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to minegoldcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into minegoldcoin-qt, and as such, will require some minor modifications to provide hooks for
