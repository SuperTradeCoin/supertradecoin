...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MineGoldCoin"),
     ...
     * override -datadir in the minegoldcoin.conf file in the default data directory
     * (to be consistent with minegoldcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
